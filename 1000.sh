echo -e "\033[1;36m 请 注 意！！！甬 哥 的 脚 本 仅 支 持 Ubuntu 与 Debain 系 统！Warp 接 管 IPV4 与 IPV6！ \033[0m"
...
echo "请输入德鸡EUserv本地IP+/128，可直接复制EUserv后台（Main IPv6-Address）信息，注意在非中文环境下复制，例：2a02:…………/128"
read -p "粘贴IPV6+/128:" eu6
